...
VALUES ( NEW.desde, NEW.hasta, NEW.monto, NEW.liquidacion, NEW.fk_lp_listaprecio, NEW.fk_lp_producto, sysdate())


CREATE TRIGGER history_prices_update
AFTER UPDATE ON lista_producto FOR EACH ROW
INSERT INTO historial (desde, hasta, monto, liquidacion, fk_lista, fk_producto, fecha )
VALUES (OLD.desde, OLD.hasta, OLD.monto, NEW.liquidacion, NEW.fk_lp_listaprecio, NEW.fk_lp_producto, sysdate())
